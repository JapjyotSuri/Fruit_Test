...
function Translator() {
    ...
    useEffect(() => {
        setLanguages(lang);
        if(res){
            const resString= `Name: ${res.name}, Calories: ${res.nutritions.calories}, Fat: ${res.nutritions.fat}, Sugar: ${res.nutritions.sugar}, Carbohydrates: ${res.nutritions.carbohydrates}, Protein: ${res.nutritions.protein}`
            setFromText(resString)
        }
    }, []);
